...
- Observational data comes from measuring a sample of the population, where we are not looking to effect the respondents, and we are not manipulating their environment. We are simply looking to *observe.*

- Experimental data includes research designs that 
...
**The foundation of statistical learning is therefore specifying the functional form $f$ in the relationship between $X$ and $Y$. In other words $f$ is the *systematic* information that $X$ provides aboout $Y$**
